...
---------------------------------------------------------------------------
 ...
 Title:      view group archived projects

 File:       vw_archived.php
...
*/
##
##	Groups: View Archived Projects sub-table
##
...
if (!($rows = $q->loadList())) {
	...
	$s .= '<tr>';
	$s .= '<th width ="100%"><a style="color:white" href="index.php?m=groups&a=view&group_id='.$company_id.'&sort=project_name">'.$AppUI->_( 'Name' ).'</a></th>'
