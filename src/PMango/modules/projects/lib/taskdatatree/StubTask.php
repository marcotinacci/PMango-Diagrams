...
class StubTask{
	...
	public function __construct()
	{
		...
		$this->data[DataArrayKeyEnumeration::$planned_start_date]="2010-01-01 02:00:00";
		$this->data[DataArrayKeyEnumeration::$planned_finish_date]="2010-01-01 06:00:00";
		...
		$this->data[DataArrayKeyEnumeration::$actual_start_date]= "2010-01-01 10:00:00";
		$this->data[DataArrayKeyEnumeration::$actual_finish_date]= null;//"2010-01-01 01:00:00";
