<?php
// $Id: gacl.class.php,v 1.1.1.1 2004/10/15 01:04:35 ajdonnison Exp $
	...
	*/
	function acl_query($aco_section_value, $aco_value, $aro_section_value, $aro_value, $axo_section_value=NULL, $axo_value=NULL, $root_aro_group=NULL, $root_axo_group=NULL, $debug=NULL) {
		...
		if (!$retarr) {
			 ...
			 */
			/*if (!is_null($root_aro_group))// non funziona il controllo sul root di aro
				$aro_group_ids[0] = $root_aro_group;
			else*///
			//$root_aro_group=array(0=>10,1=>11);
			$aro_group_ids = $this->acl_get_groups($aro_section_value, $aro_value, $root_aro_group, 'ARO');
			/*echo($aro_groups_ids);
			if (!is_null($root_aro_group)) {
				echo "<br>ARO GROUP ID: ";
				print_r($aro_groups_ids);//echo"<br>";
			}*/
