...
# Format in dotproject changelogs format (see http://sourceforge.net/projects/dotproject/)
my $DP_Output = 0;
...
sub pretty_file_list ()
{
  ...
  my $sep;                  # Separator between files
 ...
 QUNKREF:
  ...
  {
    $beauty .= " (utags: ";
    $beauty .= join ($sep, sort keys (%unanimous_tags));
    $beauty .= ")";
  }
...
Output sytles:
  ...
  --dp                         Output in dotproject's Changelog format
                               (see http://sourceforge.net/projects/dotproject/)
