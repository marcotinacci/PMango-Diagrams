...
function HTMLex()
{
  ...
  if(document.all) {
    this.addTextArea = _HTMLaddTextArea;
  } else {
    this.addTextArea = _HTMLaddHidden;
  }
}
//2}}}
...
//2}}}
//{{{2 function _HTMLaddTextArea
function _HTMLaddTextArea(id, value)
{
  var c = new Comparable
  c.add('id', id);
  c.add('name', id);
  ...
  c.add('cols', '1');
  c.add('value', value);
  return this.addNode('TEXTAREA', false, c);
}
//2}}}
