...
Ogni log è comprensivo di almeno 3 screenshot presi direttamente dall'esecuzione di PMango
su dei progetti creati appositamente: gli screenshot rispecchiano la conformazione della tripla input-environment-output.
Ove necessario, il log può comprendere anche un \emph{input_actual}, relativo alla actual view del progetto, e/o un \emph{exported_output}, risultato del comando di visualizzazione delle immagini disponibile nel browser.
%input{test_logs/[Kiwi-MGC]log_ganttBasicTaskRepresentation.tex}
\input{test_logs/[Kiwi-MGC]log_wbsTaskRepresentation.tex}
\input{test_logs/[Kiwi-MGC]log_wbsDimensionRepresentation.tex
\input{test_logs/[Kiwi-MGC]log_wbs_compositionRelationsRepresentation.tex}
