...
\input{[Kiwi-MGC]domainmodel-task.tex}
\input{[Kiwi-MGC]domainmodel-Taskbox.tex}
\input{[Kiwi-MGC]domainmodel-strip.tex}
\input{[Kiwi-MGC]domainmodel-chart.tex}
\input{[Kiwi-MGC]domainmodel-dependencies.tex}
\input{[Kiwi-MGC]domainmodel-userOption.tex}
\input{[Kiwi-MGC]domainmodel-reportSection.tex}
\end{document}